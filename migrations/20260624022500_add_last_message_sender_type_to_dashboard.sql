...
CREATE MATERIALIZED VIEW public.vw_case_dashboard_by_company AS
 ...
 SELECT c.id AS company_id,
    ...
    ( SELECT json_agg(json_build_object('case_id', o.case_id, 'client_name', o.client_name, 'client_phone', o.client_phone, 'created_at', o.created_at, 'last_message_at', o.last_message_at, 'last_message_sender_type', o.last_message_sender_type) ORDER BY o.created_at) AS json_agg
           FROM oldest_open o
...
CREATE MATERIALIZED VIEW public.vw_case_dashboard_by_company_with_department AS
 ...
 SELECT c.id AS company_id,
    ...
    ( SELECT json_agg(json_build_object('case_id', o.case_id, 'client_name', o.client_name, 'client_phone', o.client_phone, 'department_id', o.department_id, 'created_at', o.created_at, 'last_message_at', o.last_message_at, 'last_message_sender_type', o.last_message_sender_type) ORDER BY o.created_at) AS json_agg
           FROM oldest_open o
