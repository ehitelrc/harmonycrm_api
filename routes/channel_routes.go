...
func RegisterChannelRoutes(r *gin.RouterGroup) {
	...
	r.GET("/templates/channel/:channel_id", controller.GetWhatsappTemplatesByChannelID)
	...
	// Templates by integration
	r.GET("/channels/whatsapp/templates/integration/:integration_id", controller.GetWhatsappTemplatesByIntegrationID)
	...
	r.GET("/channels/integrations/whatsapp/department/:department_id", controller.GetChannelWhatsappIntegrationsByDepartmentID)
